...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_dict', default='configs/example_params.json')
    parser.add_argument('--samples_file', default='configs/samples_from_prior.json')
    parser.add_argument('--num_samples', default=100)
    parser.add_argument('--output_file', default='output/results_under_prior_random_seed=101_sample=None.csv')
