...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_template', default='example_run_under_prior')
    parser.add_argument('--true_stats', default='configs/example_true_data.csv')
    parser.add_argument('--input_simulations_pattern', default='results_under_prior_*.csv')
    parser.add_argument('--input_summaries_template', default='summary_under_prior_')
    parser.add_argument('--coverages',
        type=str,
        default='2.5_97.5,10_90,25_75')
    parser.add_argument('--comma_sep_expected_columns',
                        default='n_InGeneralWard,n_OffVentInICU,n_OnVentInICU')
